...
function renderCompetency(s, idx, total) {
  ...
  const chart = 'setTimeout(function(){var cv=document.getElementById("' + cid + '");if(!cv)return;var cnts=' + bpC + ';'
    ...
    + 'plugins:{legend:{display:false},tooltip:{backgroundColor:"#1d1d1f",titleFont:{family:"Pretendard Variable",weight:700},bodyFont:{family:"Pretendard Variable"},padding:10,cornerRadius:8,callbacks:{label:function(c){if(c.dataset.label==="건수")return "건수: "+c.raw+"건";return "금액: ₩"+c.raw.toLocaleString()+"M";}}}},'
